    ...
    <div class="mx-auto w-full max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-end">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="hidden items-center gap-3 rounded-2xl border border-gray-100 bg-white px-4 py-2.5 shadow-sm sm:flex">
        ...
        <section class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-indigo-600 to-violet-700 px-6 py-8 text-white shadow-xl shadow-indigo-500/10 sm:px-8 sm:py-10">

            <div class="relative z-10 flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between">

                <div class="max-w-2xl">

                    <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-xs font-semibold text-indigo-100 backdrop-blur-sm ring-1 ring-white/10">
                    ...
                    <p class="mt-4 text-sm font-medium text-indigo-100">
                    ...
                    <a
                        ...
                        class="mt-6 inline-flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-indigo-700 shadow-lg shadow-indigo-950/10 transition duration-200 hover:-translate-y-0.5 hover:bg-indigo-50 hover:shadow-xl"
                    >
            ...
            <div class="absolute -left-24 bottom-[-100px] h-48 w-48 rounded-full bg-indigo-400/10"></div>
        ...
        <section class="grid grid-cols-1 gap-5 md:grid-cols-3">
            ...
            <div class="group rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/5">
            ...
            <div class="group rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/5">
                ...
                <div class="flex items-start justify-between gap-4">
                    ...
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-violet-50 text-violet-600 transition duration-300 group-hover:bg-violet-600 group-hover:text-white">
        ...
        <section class="relative overflow-hidden rounded-3xl border border-indigo-100 bg-gradient-to-br from-indigo-50 via-white to-violet-50 p-5 shadow-sm sm:p-6">
            ...
            <div class="relative z-10 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a
                    href="{{ url('/admin/users') }}"
                    class="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-indigo-500/20 transition duration-200 hover:-translate-y-0.5 hover:bg-indigo-700 hover:shadow-lg"
                >
        ...
        <section class="overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-sm">
            ...
            @forelse ($recentUsers as $user)
                ...
                <div class="group border-b border-gray-50 px-5 py-5 transition duration-200 last:border-0 hover:bg-indigo-50/30 sm:px-6">
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex min-w-0 items-center gap-4">
                            ...
                            <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 text-lg font-bold text-white shadow-sm shadow-indigo-500/20">
                                {{ $initial }}
                            </div>
            ...
            @empty
                ...
                <div class="flex flex-col items-center justify-center px-6 py-16 text-center">
                    ...
                    <a
                        href="{{ url('/admin/users') }}"
                        class="mt-5 inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700"
                    >
        ...
        <section class="rounded-3xl border border-indigo-100 bg-indigo-50/70 px-5 py-5 shadow-sm sm:px-6">
