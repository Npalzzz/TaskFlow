        ...
        <div class="mx-auto max-w-7xl space-y-6 px-6">
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <a
                    ...
                    class="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-gray-200 transition hover:bg-gray-50 hover:text-indigo-600"
                >
