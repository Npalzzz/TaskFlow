        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div class="flex items-center gap-3.5">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Edit Task</h1>
                        <p class="text-sm text-gray-500 mt-0.5">Perbarui rincian tugas sesuai dengan progres atau perubahan terbaru.</p>
                    </div>
                </div>
