                ...
                <div class="flex items-center gap-3.5">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-0.5">
                            Catat tugas baru untuk mempermudah alur kerja dan deadline Anda.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="p-6 md:p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <select id="status"
                                    ...
                                    <option value="Belum"
                                        {{ old('status', 'Belum') === 'Belum' ? 'selected' : '' }}>
                                        Belum
                                    </option>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <select id="priority"
                                    ...
                                    <option value="Sedang"
                                        {{ old('priority', 'Sedang') === 'Sedang' ? 'selected' : '' }}>
                                        Sedang
                                    </option>
                        ...
                        <div>
                            ...
                            <select id="reminder_days"
                                ...
                                <option value="7"
                                    {{ old('reminder_days', 7) == 7 ? 'selected' : '' }}>
                                    H-7 — 1 minggu sebelum deadline
                                </option>

                                <option value="3"
                                    {{ old('reminder_days') == 3 ? 'selected' : '' }}>
                                    H-3 — 3 hari sebelum deadline
                                </option>

                                <option value="2"
                                    {{ old('reminder_days') == 2 ? 'selected' : '' }}>
                                    H-2 — 2 hari sebelum deadline
                                </option>

                                <option value="1"
                                    {{ old('reminder_days') == 1 ? 'selected' : '' }}>
