                ...
                <div class="mb-6 flex items-center justify-end">
                    ...
                    >
                        ...
                        <div
                            ...
                            x-transition
                            style="display: none;"
                            class="absolute right-0 z-50 mt-3 w-80 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-xl sm:w-96"
                        >

                            {{-- DROPDOWN HEADER --}}

                            <div
                                class="flex items-center justify-between border-b border-gray-100 bg-gray-50 px-5 py-4"
                            >
                                ...
                                @if ($unreadNotificationsCount > 0)
                                    ...
                                    <span
                                        class="rounded-full bg-rose-100 px-2.5 py-1 text-xs font-semibold text-rose-600"
                                    >
                            ...
                            <div class="max-h-96 overflow-y-auto">
                                ...
                                @forelse ($notifications as $notification)
                                    ...
                                    <a
                                        href="{{ !empty($data['task_id'])
                                            ? route('tasks.show', $data['task_id'])
                                            : route('notifications.index') }}"
                                        class="flex gap-3 border-b border-gray-50 px-5 py-4 transition last:border-0
                                        {{ $isUnread
                                ...
                                @empty
                                    ...
                                    <div class="px-5 py-10 text-center">
                                        ...
                                        <div
                                            class="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-gray-100 text-gray-400"
                                        >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <select
                                            name="category"
                                            onchange="this.form.submit()"
                                            class="w-full rounded-xl border border-gray-200 bg-white pl-4 pr-10 py-2.5 text-sm font-medium text-gray-600 outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 sm:w-auto"
                                        >
