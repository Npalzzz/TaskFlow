<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            ...
            <div class="group relative">
                <span class="absolute inset-y-0 left-4 flex items-center text-gray-400 transition-colors group-focus-within:text-indigo-600">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.5 20.25a8.25 8.25 0 0115 0"/></svg>
                </span>
            ...
            <x-input-error :messages="$errors->get('name')" class="mt-2 px-2" />
        </div>
        ...
        <p class="pt-4 text-center text-sm font-medium text-gray-600">
            Sudah memiliki akun?
            <a href="{{ route('login') }}" class="font-bold text-indigo-600 transition hover:text-indigo-800">
                Masuk di sini
            </a>
        </p>
    </form>
